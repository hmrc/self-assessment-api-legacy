...
import play.api.http.Status.{OK, CREATED, BAD_REQUEST, FORBIDDEN, CONFLICT, NOT_FOUND, INTERNAL_SERVER_ERROR, SERVICE_UNAVAILABLE, IM_A_TEAPOT}
...
class CreateSelfEmploymentPeriodResourceISpec extends IntegrationBaseSpec {

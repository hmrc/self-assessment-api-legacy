...
import uk.gov.hmrc.r2.selfassessmentapi.models.{AuthorisationErrorResult, ErrorResult, Errors, GenericErrorResult, PathValidationErrorResult, ValidationErrorResult}
...
package object resources {
  ...
  implicit class DesBusinessResult[R <: Response](result: BusinessResult[R]) {
    ...
    def onDesSuccess(handleSuccess: R => Result)(implicit ec: ExecutionContext): Future[Result] = {
      for {

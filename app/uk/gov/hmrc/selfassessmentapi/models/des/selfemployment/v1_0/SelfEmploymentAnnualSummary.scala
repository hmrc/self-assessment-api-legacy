...
import uk.gov.hmrc.selfassessmentapi.models.des.selfemployment.v1_0.Financials.expense2Deduction
...
object SelfEmploymentAnnualSummary {
  ...
  def from(apiSummary: models.selfemployment.v1_0.SelfEmploymentAnnualSummary): SelfEmploymentAnnualSummary = {

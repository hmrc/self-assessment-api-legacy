...
object Errors {
  ...
  object RequiredEndOfPeriodStatement extends Error("REQUIRED_END_OF_PERIOD_STATEMENT", "Cannot submit intent to crystallisation without submitting End of Period Statement.", None)

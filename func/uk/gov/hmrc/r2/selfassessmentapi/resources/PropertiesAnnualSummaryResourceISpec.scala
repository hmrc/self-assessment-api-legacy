    ...
    for (propertyType <- Seq(PropertyType.OTHER, PropertyType.FHL)) {
      s"return code 204 when amending annual summaries for $propertyType" in {
        given()
          ...
          .when()
          .put(annualSummary(propertyType)).at(s"/r2/ni/${nino.nino}/uk-properties/$propertyType/$taxYear")
          .thenAssertThat()
          .statusIs(204)
      }
      ...
      s"return code 400 when amending annual summaries with invalid data for $propertyType" in {
        ...
        given()
          ...
          .clientIsFullyAuthorisedForTheResource
          .when()
          .put(invalidAnnualSummary(propertyType)).at(s"/r2/ni/${nino.nino}/uk-properties/$propertyType/$taxYear")
          .thenAssertThat()
          .statusIs(400)
          .contentTypeIsJson()
      ...
      s"return code 400 when updating properties annual summary for a non MTD year for $propertyType" in {
        given()
          ...
          .clientIsFullyAuthorisedForTheResource
          .when()
          .put(annualSummary(propertyType)).at(s"/r2/ni/${nino.nino}/uk-properties/$propertyType/2015-16")
          .thenAssertThat()
          .statusIs(400)
  ...
  "amending annual summaries for FHL Property business" should {
    "return code 400 when submitted with invalid data for 'Period of grace adjustment'" in {
      ...
      given()
        ...
        .clientIsFullyAuthorisedForTheResource
        .when()
        .put(s"/r2/ni/${nino.nino}/uk-properties/${PropertyType.FHL}/$taxYear", Some(Jsons.Properties.invalidFhlAnnualSummary))
        .thenAssertThat()
        .statusIs(400)
        .contentTypeIsJson()
    ...
    for (propertyType <- Seq(PropertyType.OTHER, PropertyType.FHL)) {
      s"return code 200 containing annual summary information for $propertyType" in {
        ...
        given()
          ...
          .when()
          .get(s"/r2/ni/${nino.nino}/uk-properties/$propertyType/$taxYear")
          .thenAssertThat()
          .statusIs(200)
          .contentTypeIsJson()
      ...
      s"return code 400 when retrieving annual summary for a non MTD year for $propertyType" in {
        given()
          ...
          .clientIsFullyAuthorisedForTheResource
          .when()
          .get(s"/r2/ni/${nino.nino}/uk-properties/$propertyType/2015-16")
          .thenAssertThat()
          .statusIs(400)
          .bodyIsError("TAX_YEAR_INVALID")
      }

...
package uk.gov.hmrc.selfassessmentapi.models.des.selfemployment.v1_0

import play.api.libs.json._
import uk.gov.hmrc.selfassessmentapi.models
import uk.gov.hmrc.selfassessmentapi.models.Expense
...
object SelfEmploymentPeriod {
  ...
  def from(apiSePeriod: models.selfemployment.v1_0.SelfEmploymentPeriod): SelfEmploymentPeriod = {
...
object Financials {
  ...
  def expense2Deduction(expense: Expense): Deduction =
  ...
  def from(apiSePeriod: models.selfemployment.v1_0.SelfEmploymentPeriod): Financials = {
  ...
  def from(sePeriodUpdate: models.selfemployment.v1_0.SelfEmploymentPeriodUpdate): Financials =

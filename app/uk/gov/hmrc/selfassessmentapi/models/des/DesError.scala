...
object DesErrorCode extends Enumeration {
  ...
  val INVALID_NINO, INVALID_PAYLOAD, NOT_FOUND_NINO, NOT_FOUND, CONFLICT, SERVER_ERROR, SERVICE_UNAVAILABLE,
  INVALID_PERIOD, INVALID_ORIGINATOR_ID, INVALID_REQUEST, INVALID_BUSINESSID, TAX_YEAR_INVALID, NOT_FOUND_TAX_YEAR,
  NOT_FOUND_BUSINESS_ID, INVALID_CALCID, INVALID_INCOME_SOURCE = Value

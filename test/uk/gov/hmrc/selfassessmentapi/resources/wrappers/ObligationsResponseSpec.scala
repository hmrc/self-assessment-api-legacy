...
class ObligationsResponseSpec extends UnitSpec {
  ...
  "ObligationResponse" should {
    "wrap valid response" in {
      ...
      seObligations.get.obligations.find(o => o.start == new LocalDate("2017-01-01")) shouldBe defined

      val propObligations = response.obligations("ITSP")
      propObligations.get.obligations.find(o => o.start == new LocalDate("2017-01-02")) shouldBe defined
    }
  }
}

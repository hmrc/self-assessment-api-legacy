...
import play.api.http.Status.{INTERNAL_SERVER_ERROR, NOT_FOUND, OK, IM_A_TEAPOT}
...
class PropertiesPeriodResourceSpec extends IntegrationBaseSpec {
  ...
  private trait Test {
    ...
    def uri(propertyType: PropertyType): String = s"/ni/${nino.nino}/uk-properties/$propertyType/periods"

  ...
  object Obligations {
    def apply(id: String = "abc"): String = {
      s"""
         ...
         |          "inboundCorrespondenceDueDate": "2017-07-05",
         |          "periodKey": "004"
         |        },
         |        {
         |          "status": "O",
         ...
         |          "inboundCorrespondenceDueDate": "2017-10-05",
         |          "periodKey": "004"
         |        },
         |        {
         |          "status": "O",
         ...
         |          "inboundCorrespondenceDueDate": "2018-01-05",
         |          "periodKey": "004"
         |        },
         |        {
         |          "status": "O",
         ...
         |          "inboundCorrespondenceDueDate": "2018-04-05",
         |          "periodKey": "004"
         |        }
         |      ]
         |    },

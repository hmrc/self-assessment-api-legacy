...
import uk.gov.hmrc.r2.selfassessmentapi.models.{amountValidator, nonNegativeAmountValidator}
...
object Adjustments {
  ...
  implicit val reads: Reads[Adjustments] = (
      ...
      (__ \ "goodsAndServicesOwnUse").readNullable[BigDecimal](nonNegativeAmountValidator)
    ) (Adjustments.apply _)
}

  ...
  override def onBadRequest(request: RequestHeader, error: String) = {
    ...
    super.onBadRequest(request, error).map { result =>
      error match {
        ...
        case "ERROR_INVALID_DATE_FROM"     => BadRequest(toJson(ErrorBadRequest(INVALID_DATE, "The date from in the query string is invalid")))
        case "ERROR_INVALID_DATE_TO"       => BadRequest(toJson(ErrorBadRequest(INVALID_DATE, "The date to in the query string is invalid")))
        case "ERROR_INVALID_DATE_RANGE"    => BadRequest(toJson(ErrorBadRequest(INVALID_DATE, "The date range in the query string is invalid")))

...
package uk.gov.hmrc.r2.selfassessmentapi.httpparsers

import play.api.http.Status
import play.api.libs.json._
import uk.gov.hmrc.http.HttpResponse
import uk.gov.hmrc.r2.selfassessmentapi.models.Errors.{DesError, Error, ErrorWrapper, InvalidRequest, NinoInvalid, NoSubmissionDataExists, SelfEmploymentIDInvalid, ServerError, ServiceUnavailable, TaxYearInvalid}
